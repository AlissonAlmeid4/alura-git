...
CREATE TABLE IF NOT EXISTS `tb_produtos` (
  ...
  `nomePrato` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'imgs/720afa6a0d739552661f5f8d17a4f717.jpg', 'Bruschetta Tradicional', 'Salgado', 'Bruschetta', 'O macarrão pode não ter surgido na Itália, mas com certeza, os italianos que aperfeiçoaram essa deliciosa massa com molhos impecáveis. O mais famoso deles, inclusive aqui no Brasil, é o molho à bolonh', '30', '19'),
